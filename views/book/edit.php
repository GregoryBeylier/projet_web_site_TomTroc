...
<body>
    ...
    <form action="index.php?controller=book&action=edit&id=<?php echo $book['id']; ?>" method="post" enctype="multipart/form-data">
        ...
        <textarea id="description" name="description" rows="4" cols="50"><?php echo htmlspecialchars($book['description']); ?></textarea><br>

        <label for="available">disponibilité :</label>
        <select id="available" name="status">
            <option value="1" <?php if ($book['status'] == 1) echo 'selected'; ?>>disponible</option>
            <option value="0" <?php if ($book['status'] == 0) echo 'selected'; ?>>indisponible</option>
        </select><br>
